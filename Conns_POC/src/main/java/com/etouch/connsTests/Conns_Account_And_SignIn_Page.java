...
public class Conns_Account_And_SignIn_Page extends BaseTest {
		...
		try{
			...
			{	String Page_Expected_URL = test_data[r][4];
				...
				{	String My_Wish_List_Mobile_Page_Expected_URL = mobile_validation_data[r1][4];
					...
					softAssert.assertTrue(Page_URL_Title_Data_My_Wish_List_Links.get(0).equalsIgnoreCase(My_Wish_List_Mobile_Page_Expected_Title),        " Account Information DashBoard Tab verification failed For My_Wish_List_Page_Expected_Title.              My_Wish_List_Page_Expected_Title              : "+ My_Wish_List_Mobile_Page_Expected_Title        + "   My_Wish_List_Page_Actual_Title                        : "+ Page_URL_Title_Data_My_Wish_List_Links.get(0));	
					softAssert.assertTrue(Page_URL_Title_Data_My_Wish_List_Links.get(1).contains(My_Wish_List_Mobile_Page_Expected_URL),                  " Account Information DashBoard Tab verification failed For My_Wish_List_Page_Expected_URL .               My_Wish_List_Page_Expected_URL                : "+ My_Wish_List_Mobile_Page_Expected_URL          + "   My_Wish_List_Page_Actual_URL                          : "+ Page_URL_Title_Data_My_Wish_List_Links.get(1));
					softAssert.assertTrue(Page_URL_Title_Data_My_Wish_List_Links.get(2).equalsIgnoreCase(My_Wish_List_Mobile_Page_Expected_Element_Name), " Account Information DashBoard Tab verification failed For My_Wish_List_Page_Expected_Element_Name .      My_Wish_List_Page_Expected_Element_Name       : "+ My_Wish_List_Mobile_Page_Expected_Element_Name + "   My_Wish_List_Page_Actual_Element_Name                 : "+ Page_URL_Title_Data_My_Wish_List_Links.get(2));
					softAssert.assertTrue(Page_URL_Title_Data_My_Wish_List_Links.get(3).equalsIgnoreCase(My_Wish_List_Mobile_Page_Element_Locator_Text),  " Account Information DashBoard Tab verification failed For My_Wish_List_Mobile_Page_Element_Locator_Text. My_Wish_List_Mobile_Page_Element_Locator_Text : "+ My_Wish_List_Mobile_Page_Element_Locator_Text  + "   Actual_My_Wish_List_Mobile_Page_Element_Locator_Text  : "+ Page_URL_Title_Data_My_Wish_List_Links.get(3));
				...
				{	String My_Wish_List_Web_Page_Expected_URL = web_validation_data[r1][4];
					...
					//commonMethods.clickElementbyXpath(webPage, Resizeable_Account_DashBoard_Menu_Web_Drop_Down_Wish_List_Option, softAssert);
	...
	public void verify_Register_Create_New_Customer_Functionality_with_Valid_Input() throws InterruptedException {
		...
		try{
			...
			String Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text = web_data[0][42];
			...
			String Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text = web_data[0][54];
			...
			String Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text = test_data[0][42];
			...
			String Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text = test_data[0][54];
			...
			log.info("***************************************** Account Dashboard Drop Down For Mobile will be starting********************************");
				if (testType.equalsIgnoreCase("Mobile")) {
					...
					softAssert.assertTrue(actualErrorMessage.get(0). equalsIgnoreCase(Mobile_Email_Address_Success_Message_Locator_Expected_Text) ,														"Login Functionality with Valid Input verification failed For Mobile_Email_Address_Success_Message_Locator_Expected_Text . 													  Mobile_Email_Address_Success_Message_Locator_Expected_Text :" 													+ Mobile_Email_Address_Success_Message_Locator_Expected_Text   											           + " Mobile_Email_Address_Success_Message_Locator_Actual_Text : " 												    + actualErrorMessage.get(0));
					softAssert.assertTrue(actualErrorMessage.get(1). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text),										"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text . 								  Mobile_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text :" 									+ Mobile_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text                        	           + " Mobile_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Actual_Text : " 								    + actualErrorMessage.get(1));
					softAssert.assertTrue(actualErrorMessage.get(2). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text),									"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text.								  Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text :" 								+ Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text                                   + " Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Actual_Text : " 							    + actualErrorMessage.get(2));
					softAssert.assertTrue(actualErrorMessage.get(3). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text. 					  Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text :" 						+ Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text                         + " Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Actual_Text : " 					    + actualErrorMessage.get(3));
					softAssert.assertTrue(actualErrorMessage.get(4). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text. 		              Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text :" 						+ Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text                        + " Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Actual_Text : " 				        + actualErrorMessage.get(4));
					//softAssert.assertTrue(actualErrorMessage.get(5). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text. 		              Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text :"						+ Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text                        + " Mobile_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Actual_Text : " 				        + actualErrorMessage.get(5));
					softAssert.assertTrue(actualErrorMessage.get(6). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text. 					 	  Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text :"								+ Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text                               + " Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Actual_Text : " 						    + actualErrorMessage.get(6));
					softAssert.assertTrue(actualErrorMessage.get(7). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text),							"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text. 			              Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text :" 						+ Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text                          + " Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Actual_Text : "                        + actualErrorMessage.get(7));
					softAssert.assertTrue(actualErrorMessage.get(8). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text),										"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text . 									  Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text :" 									+ Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text                                       + " Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Actual_Text : "                                     + actualErrorMessage.get(8));
					softAssert.assertTrue(actualErrorMessage.get(9). equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text),									"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text . 							  Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text :"								+ Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text                                  + " Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Actual_Text : "                                + actualErrorMessage.get(9));
					softAssert.assertTrue(actualErrorMessage.get(10).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text. 							  Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text :"								+ Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text                               + " Mobile_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Actual_Text : "                             + actualErrorMessage.get(10));
					//softAssert.assertTrue(actualErrorMessage.get(11).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text),				"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text. 				  Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text :"					+ Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text                   + " Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Actual_Text : "                 + actualErrorMessage.get(11));
					softAssert.assertTrue(actualErrorMessage.get(12).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text),			"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text. 		  Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text :"			+ Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text             + " Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Actual_Text : "           + actualErrorMessage.get(12));
					softAssert.assertTrue(actualErrorMessage.get(13).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text),	"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text. Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text :" + Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text   + " Mobile_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Actual_Text : " + actualErrorMessage.get(13));
					softAssert.assertTrue(actualErrorMessage.get(14).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text),										"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text. 								      Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text :"                     				+ Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text                                      + " Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Actual_Text : "									+ actualErrorMessage.get(14));
					softAssert.assertTrue(actualErrorMessage.get(15).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text . 				  Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text :" 					+ Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text   				   + " Mobile_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Actual_Text : " 				    + actualErrorMessage.get(15));
					softAssert.assertTrue(actualErrorMessage.get(16).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text),							"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text. 						  Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text :" 						+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text   						   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_ActualText : " 						    + actualErrorMessage.get(16));
					softAssert.assertTrue(actualErrorMessage.get(17).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text),							"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text. 					      Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text :" 						+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text   					   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Actual_Text : " 						+ actualErrorMessage.get(17));
					softAssert.assertTrue(actualErrorMessage.get(18).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text. 				  Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text :" 				+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text  				   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Actual_Text : " 				+ actualErrorMessage.get(18));
					softAssert.assertTrue(actualErrorMessage.get(19).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text. 			      Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text :" 				+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text   			   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Actual_Text : " 				+ actualErrorMessage.get(19));
					softAssert.assertTrue(actualErrorMessage.get(20).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text),				"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text. 		      Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text :" 			+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text   		   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Actual_Text : "            + actualErrorMessage.get(20));
					softAssert.assertTrue(actualErrorMessage.get(21).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text),			"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text. 		  Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text :" 			+ Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text  		   + " Mobile_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Actual_Text : "           + actualErrorMessage.get(21));
					softAssert.assertTrue(actualErrorMessage.get(22).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text),										"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text. 									  Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text :" 									    + Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text  									   + " Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Actual_Text : "                                      + actualErrorMessage.get(22));
					softAssert.assertTrue(actualErrorMessage.get(23).equalsIgnoreCase(Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text. 							  Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text :" 							    + Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text                                + " Mobile_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Actual_Text : "                              + actualErrorMessage.get(23));
					...
					softAssert.assertTrue(actualErrorMessage.get(0). equalsIgnoreCase(Web_Email_Address_Success_Message_Locator_Expected_Text) ,													"Login Functionality with Valid Input verification failed For Web_Email_Address_Success_Message_Locator_Expected_Text . 									                Web_Email_Address_Success_Message_Locator_Expected_Text : " 									                + Web_Email_Address_Success_Message_Locator_Expected_Text   				 									+ " Web_Email_Address_Success_Message_Locator_Actual_Text : "													  + actualErrorMessage.get(0));
					softAssert.assertTrue(actualErrorMessage.get(1). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text),									"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text . 									Web_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text : " 									+ Web_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Expected_Text   									+ " Web_Newly_Created_User_Name_DashBoard_Header_Title_Locator_Actual_Text : " 									  + actualErrorMessage.get(1));
					softAssert.assertTrue(actualErrorMessage.get(2). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text),									"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text . 								Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text : " 								+ Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Expected_Text   								+ " Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Locator_Actual_Text : " 								  + actualErrorMessage.get(2));
					softAssert.assertTrue(actualErrorMessage.get(3). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text . 						Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text : " 						+ Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Expected_Text  						+ " Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Sub_Title_Locator_Actual_Text : " 					  + actualErrorMessage.get(3));
					softAssert.assertTrue(actualErrorMessage.get(4). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text . 						Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text : " 						+ Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Expected_Text   						+ " Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_1_Locator_Actual_Text : " 					  + actualErrorMessage.get(4));
					//softAssert.assertTrue(actualErrorMessage.get(5). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text .						Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text : "						+ Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Expected_Text  						+ " Web_Newly_Created_User_Name_DashBoard_Welcome_Message_Greeting_2_Locator_Actual_Text : " 					  + actualErrorMessage.get(5));
					softAssert.assertTrue(actualErrorMessage.get(6). contains(Web_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text),								        "Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text . 							Web_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text : " 							+ Web_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Expected_Text   							+ " Web_Newly_Created_User_Name_DashBoard_Contact_Information_Locator_Actual_Text : " 							  + actualErrorMessage.get(6));
					softAssert.assertTrue(actualErrorMessage.get(7). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text . 						Web_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text : " 						+ Web_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Expected_Text  						+ " Web_Newly_Created_User_Name_DashBoard_Contact_Information_Edit_Locator_Actual_Text : " 						  + actualErrorMessage.get(7));
					softAssert.assertTrue(actualErrorMessage.get(8). contains(Web_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text),										        "Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text . 									Web_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text : " 									+ Web_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Expected_Text   									+ " Web_Newly_Created_User_Name_DashBoard_Newsletters_Locator_Actual_Text : "									  + actualErrorMessage.get(8));
					softAssert.assertTrue(actualErrorMessage.get(9). equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text . 								Web_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text : " 								+ Web_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Expected_Text   								+ " Web_Newly_Created_User_Name_DashBoard_Newsletters_Edit_Locator_Actual_Text : " 								  + actualErrorMessage.get(9));
					softAssert.assertTrue(actualErrorMessage.get(10).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text . 							Web_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text : " 							+ Web_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Expected_Text   							+ " Web_Newly_Created_User_Name_DashBoard_Newsletters_Content_Locator_Actual_Text : " 							  + actualErrorMessage.get(10));
					//softAssert.assertTrue(actualErrorMessage.get(11).contains(Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text),					        "Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text . 			Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text : " 				+ Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Expected_Text   				+ " Web_Newly_Created_User_Name_DashBoard_Contact_Information_1st_Content_Locator_Actual_Text : " 				  + actualErrorMessage.get(11));
					softAssert.assertTrue(actualErrorMessage.get(12).contains(Web_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text),			        "Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text .			Web_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text : " 			+ Web_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Expected_Text  			+ " Web_Newly_Created_User_Name_DashBoard_Contact_Information_2nd_Content_Email_Locator_Actual_Text : "           + actualErrorMessage.get(12));
					softAssert.assertTrue(actualErrorMessage.get(13).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text),	"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text . Web_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text : " + Web_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Expected_Text   + " Web_Newly_Created_User_Name_DashBoard_Contact_Information_3rd_Content_Change_Password_Locator_Actual_Text : " + actualErrorMessage.get(13));
					softAssert.assertTrue(actualErrorMessage.get(14).contains(Web_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text),									"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text .									        Web_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text : " 									+ Web_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Expected_Text   									+ " Web_Newly_Created_User_Name_DashBoard_Address_Book_Locator_Actual_Text : "                                    + actualErrorMessage.get(14));
					softAssert.assertTrue(actualErrorMessage.get(15).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text .					Web_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text : " 					+ Web_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Expected_Text  					+ " Web_Newly_Created_User_Name_DashBoard_Address_Book_Manage_Addresses_Locator_Actual_Text : "                   + actualErrorMessage.get(15));
					softAssert.assertTrue(actualErrorMessage.get(16).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text),							"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text . 						Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text : " 						+ Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Locator_Expected_Text   						+ " Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Actual_Text : "                        + actualErrorMessage.get(16));
					softAssert.assertTrue(actualErrorMessage.get(17).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text),						"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text . 						Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text : " 						+ Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Expected_Text   						+ " Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Locator_Actual_Text : "                        + actualErrorMessage.get(17));
					softAssert.assertTrue(actualErrorMessage.get(18).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text),					"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text . 				Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text : " 				+ Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Expected_Text  					+ " Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Content_Locator_Actual_Text : " 				  + actualErrorMessage.get(18));
					softAssert.assertTrue(actualErrorMessage.get(19).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text),				"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text . 				Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text : " 				+ Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Expected_Text  				+ " Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Content_Locator_Actual_Text : " 				  + actualErrorMessage.get(19));
					softAssert.assertTrue(actualErrorMessage.get(20).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text),			"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text . 			Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text : " 			+ Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Expected_Text   			+ " Web_Newly_Created_User_Name_DashBoard_Primary_Billing_Address_Edit_Address_Locator_Actual_Text : " 			  + actualErrorMessage.get(20));
					softAssert.assertTrue(actualErrorMessage.get(21).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text),			"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text . 			Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text : " 			+ Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Expected_Text  			+ " Web_Newly_Created_User_Name_DashBoard_Primary_Shipping_Address_Edit_Address_Locator_Actual_Text : " 		  + actualErrorMessage.get(21));
					softAssert.assertTrue(actualErrorMessage.get(22).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text),										"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text . 										Web_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text : "										+ Web_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Expected_Text   									    + " Web_Newly_Created_User_Name_DashBoard_Credit_App_Locator_Actual_Text : " 									  + actualErrorMessage.get(22));
					softAssert.assertTrue(actualErrorMessage.get(23).equalsIgnoreCase(Web_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text),								"Login Functionality with Valid Input verification failed For Web_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text . 								Web_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text : " 								+ Web_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Expected_Text   								+ " Web_Newly_Created_User_Name_DashBoard_Credit_App_Content_Locator_Actual_Text : " 							  + actualErrorMessage.get(23));
					softAssert.assertAll();
					} 
				log.info("***************************************** Account Dashboard Drop Down For Web Count ******************************** : " +count);
				softAssert.assertAll();
