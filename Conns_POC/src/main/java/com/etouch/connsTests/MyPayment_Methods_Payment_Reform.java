...
public class MyPayment_Methods_Payment_Reform extends BaseTest {
	...
	public void MyPaymentMethod_Main_Page() throws ClientProtocolException, IOException, InterruptedException {
		...
		try {
			...
			MyPaymentMethodsPaymentReformPage.PageTitle_PageURL_Validation(verify_SignIn_With_Valid_Input,ExpectedURL,ExpectedPageTitle);		
			
			log.info(" *************************** Login Credentials for Registered User *****************************************************************************");
			for (int i = 0; i < 2; i++) {
				commonMethods.sendKeysbyXpath(webPage, verify_SignIn_With_Valid_Input[i][1], verify_SignIn_With_Valid_Input[i][2], softAssert);
			}	
	...
	public void MyPaymentMethod_CreditCard_Page() throws ClientProtocolException, IOException, InterruptedException {
		...
		MyPaymentMethodsPaymentReformPage.PageTitle_PageURL_Validation(VerifyCreditCardFundingPortal,ExpectedURL,ExpectedPageTitle);
		commonMethods.waitForPageLoad(webPage, softAssert);	
		...
		WebElement element = webPage.getDriver().findElement(By.xpath(VerifyCreditCardFundingPortal[0][1]));
			...
			for (int i = 1; i <= 4; i++) {
				commonMethods.sendKeysbyXpath(webPage, VerifyCreditCardFundingPortal[i][1], VerifyCreditCardFundingPortal[i][2], softAssert);
			}	
			...
			MyPaymentMethodsPaymentReformPage.Button_Xpath_Validation(webPage,VerifyCreditCardFundingPortal, SaveCreditCardButtonXpath, softAssert);				
			...
			{ 	String SuccessMessageXPATH = VerifyCreditCardFundingPortal[i][1];
				...
				MyPaymentMethodsPaymentReformPage.SuccessMessageValidation(webPage,  VerifyCreditCardFundingPortal,SuccessMessageXPATH,ExpectedSuccessMessageTEXT, softAssert);
			}
			...
			/****************** MyPaymentMethod_Page_AddNewPaymentMethod Button Display Validation ************************************/
			String AddNewPaymentMethodButtonXpath = VerifyCreditCardFundingPortal[13][1];
			MyPaymentMethodsPaymentReformPage.Button_Xpath_Validation(webPage,VerifyCreditCardFundingPortal, AddNewPaymentMethodButtonXpath, softAssert);				
	...
	public void MyPaymentMethod_Banking_Page() throws ClientProtocolException, IOException, InterruptedException {
		...
		MyPaymentMethodsPaymentReformPage.PageTitle_PageURL_Validation(VerifyBankingFundingPortal,ExpectedURL,ExpectedPageTitle);
		...
		WebElement element = webPage.getDriver().findElement(By.xpath(VerifyBankingFundingPortal[0][1]));
			...
			for (int i = 1; i < 5; i++) {
				commonMethods.sendKeysbyXpath(webPage, VerifyBankingFundingPortal[i][1], VerifyBankingFundingPortal[i][2], softAssert);
			}
			...
			for (int i = 5; i < 6; i++) {
				...
				commonMethods.sendKeysbyXpath(webPage, VerifyBankingFundingPortal[i][1], AccountNumberAsString, softAssert);
			}
			...
			{ 	String SuccessMessageXPATH = VerifyBankingFundingPortal[i][1];
				...
				MyPaymentMethodsPaymentReformPage.SuccessMessageValidation(webPage,  VerifyBankingFundingPortal,SuccessMessageXPATH,ExpectedSuccessMessageTEXT, softAssert);
			}
