		...
		try{
			...
			for (int i = 0; i < allRegionDescriptiondata.length; i++) {
			   ...
			   // if(!browserName.equalsIgnoreCase("InternetExplorer")){
			   	...
			   	Thread.sleep(3000);
			    String breadCrumbsActualText = (String) js.executeScript("return arguments[0].text", webPage.getDriver().findElement(By.xpath(allRegionDescriptiondata[i][7])).toString());
